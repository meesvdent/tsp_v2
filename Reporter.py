...
class Reporter:
    ...
    def __init__(self, filename):
        ...
        self.filename = "out/" + filename + ".csv"
        self.delimiter = ','
    ...
    def write_params(self, r0652717):
        outFile = open(self.filename, "w")
        outFile.write("init_size: " + str(r0652717.init_size)+
                      " mu: " + str(r0652717.mu) +
                      " alpha: " + str(r0652717.alpha) +
                      " beta: " + str(r0652717.beta)+
                      " lambdaa: "+ str(r0652717.lambdaa)+
                      " init_param: "+ str(r0652717.init_param)+ "\n")
        outFile.close()
